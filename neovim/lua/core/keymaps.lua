...
-- DAP
--
vim.keymap.set('n', '<F5>', '<cmd>lua require"dap".continue(, opts)<CR>')
vim.keymap.set('n', '<F6>', '<cmd>lua require"dap".step_over(, opts)<CR>')
vim.keymap.set('n', '<F7', '<cmd>lua require"dap".step_into(, opts)<CR>')
vim.keymap.set('n', '<F8>', '<cmd>lua require"dap".step_out(, opts)<CR>')
vim.keymap.set('n', '<F9>', '<cmd>lua require"dap".terminate(, opts)<CR>')
vim.keymap.set('n', '<space>b', '<cmd>lua require"dap".toggle_breakpoint(, opts)<CR>')
-- vim.keymap.set('n', '<F5>', '<cmd>lua require"dap".continue(, opts)<CR>')
